...
public class TrackController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<GlobalApiResponse<TrackDetailDTO>> getTrackDetail(@PathVariable Long id) {
        return ResponseEntity.ok(GlobalApiResponse.success(trackService.getTrackDetail(id)));
    }
}
